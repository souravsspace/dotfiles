...
| Key(s)    | Mode(s) | Description                                                                         | Notes                                |
| :-------- | :------ | :---------------------------------------------------------------------------------- | :----------------------------------- |
| `f{char}` | N, V, O | Go forward **to** the `[count]`th occurrence of `{char}`.                           | Cursor lands _on_ the character.     |
| `F{char}` | N, V, O | Go backward **to** the `[count]`th occurrence of `{char}`.                          | Cursor lands _on_ the character.     |
...
| Key(s)             | Mode(s) | Description                                                            | Notes                                                                        |
| :----------------- | :------ | :--------------------------------------------------------------------- | :--------------------------------------------------------------------------- |
| `m{a-zA-Z}`        | N       | **Set mark** `{a-zA-Z}` at cursor position.                            | Lowercase local to buffer, uppercase global (file marks). _Not a motion._    |
