...
# We install Starship itself via Homebrew or your OS package manager;
zinit ice atload"!STARSHIP_CONFIG=${HOME}/dotfiles/starship/starship.toml; eval \"\$(starship init zsh)\"" lucid
